...
from orchestration.assets import delete_reconciliation, extraction_assets
...
defs = Definitions(
    assets=[*extraction_assets, delete_reconciliation, construction_supplies_dbt_assets],
