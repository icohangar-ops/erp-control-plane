"""The promotion loop: NL answer -> guardrailed execution -> governed Superset artifact.
...
1. **Guardrails first** (fail closed): the answer SQL executes against the
...
2. **Governed persistence** (under the per-question mutex): dataset on the
   ...
   merged per the runbook rules with the "Ask → Save" markdown header.
...
class PromotionService:
    ...
    def promote(
        ...
        """Guardrail, execute, audit, then persist the answer as a chart."""
